...
def test_colors_with_same_count():
    ...
    assert favorite_color({'Carl': 'Purple', 'Bob': 'Red', 'Tod': 'Red', 'Shawn': 'Purple'}) == 'Purple'


def test_colors_with_different_count():
    """The given_dict has two colors with the same highest appearance, and the first color should be returned."""
    assert favorite_color({'Carl': 'Purple', 'Bob': 'Red', 'Tod': 'Orange', 'Shawn': 'Purple', 'Derrick': 'Orange', 'Delilah': 'Orange'}) == 'Orange'
...
def test_list_with_multiple_apearance_per_key():
...
def test_weekday_not_in_log():
    """The function is given a weekday that is not already in the attendance log to add a new student to."""
...
def test_weekday_in_log():
    """The function is given a weekday that is already in the attendance log to add a student to."""
